                    ...
                    <center>
                        <?php
                            if (isset($_SESSION["admin"])) {
                                ...
                                echo "
                                    <strong>Vous pouvez supprimer votre compte à tout moment. En revanche, si vous changez d'avis, sachez que vous ne pourrez pas le récupérer.</strong><br/><br/>
                                    <h3>Conséquences :</h3><br/>
                                    - Vous perdrez l'ensemble des données et des contenus de ce compte<br/>
                                    - Toutes vos réservations seront annulées<br/><br/><br/><br/>
                                    <a href='confirmation_suppression.php' class='btn btn-danger'>Supprimer</a>
                                ";
                            }
                        ?>
                    </center>
